...
with open('/home/ridvan/Documents/center_surround/outputs/hyperparam_results_1.pkl', 'rb') as f:
...
# Load data
data_path = "/home/ridvan/Documents/center_surround/data/exp_13_data_1.pkl"
...
picked_cells = [187, 478, 684, 721, 723, 1036, 1091, 1260, 1443, 1506]
...
model_config = {
    ...
    'init_kernels': 'gaussian:0.2',
    'num_neurons': num_neurons,
    'smoothness_reg': best_params['smoothness_reg'],
    'sparsity_reg': 0,
    'center_mass_reg': best_params['center_mass_reg'],
    'mask_reg': 0.0001,
...
model = train(model, dataloaders, num_epochs=100, lr=best_params['learning_rate'], device=device)
...
print(f"  - correlation_vs_reliability.png")
print(f"  - kernels.png")
